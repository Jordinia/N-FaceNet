...
import os
import requests
from detections.outfit_detection_gpu import check_outfit  # Import the check_outfit function
...
def process_camera_stream(cam_id: int, cam_url: str):
    ...
    person_model = YOLO("detections/weights/yolo11m.engine")
    outfit_model = YOLO("detections/weights/topbottomv2_fp32.engine")
